...
public class ImageLoader {
    ...
    //private final int stub_id_2 = R.drawable.song_album_art;
    //private final int stub_id_ = R.drawable.song_album_art;

    private int which;
    private int stub_id = R.drawable.song_album_art;

    public ImageLoader(Context context, int which){
        c = context;
        this.which = which;
        ...
        switch (which){
            case 1:
                stub_id = R.drawable.song_album_art;
                break;
            case 2:
                stub_id = R.drawable.album_cd;
                break;
            case 3:
                stub_id = R.drawable.default_album_art;
                break;
        }
    }
    ...
    public boolean displayImage2(String url, ImageView imageView) {
    ...
    private Bitmap getBitmap(String url) {
        ...
        try {
            if(which == 1 || which == 3) {
                bitmap = Utility.getSongAlbumArt(c, Uri.parse(url));
            } else {
                bitmap = Utility.getAlbumThumbnails(c, Uri.parse(url));
            }
            if (bitmap != null)
                return bitmap;
        }
